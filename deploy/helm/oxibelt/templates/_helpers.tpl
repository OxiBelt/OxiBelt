...
{{- if not (or (semverCompare "=3.22.0" $helmVersion) (semverCompare "=4.3.0" $helmVersion)) -}}
{{- fail (printf "OxiBelt Kubernetes qualification requires Helm 3.22.0 or 4.3.0, found %s; see docs/KubernetesSupport.md" $helmVersion) -}}
{{- end -}}
