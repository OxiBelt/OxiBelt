...
| `sybil-rate-limit-identities` | `experimental` | Config/WAF/data plane | Rate-limit buckets support client IP prefixes, TLS fingerprints, ASN, composite client identities, WAF token-binding hashes, and verified Person proof clearance hashes. |
