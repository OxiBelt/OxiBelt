...
selection and rollback procedure below remain applicable.
...
predicates prevented a reusable qualification result. Preserve its immutable
release history, but do not reuse its artifacts, attestations, vulnerability
