...
#[path = "person_proof/support.rs"]
mod support;
use support::{challenge_html, challenge_security_headers};
pub(super) use support::{hex_decode, hex_encode, now_unix_ms, random_hex, remaining_seconds};
