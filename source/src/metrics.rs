...
pub struct Metrics {
  ...
  web_bot_auth_absent_total: AtomicU64,
  web_bot_auth_verified_total: AtomicU64,
  web_bot_auth_invalid_total: AtomicU64,
  web_bot_auth_unverified_total: AtomicU64,
  ...
  ct: ct::CtMetrics,
  downstream_ct: downstream_ct::DownstreamCtMetrics,
...
impl Metrics {
  ...
  pub fn prometheus(
    ...
    self.append_downstream_ct_prometheus(&mut output);
