...
pub(crate) struct StreamWafRequestContext {
  ...
  version: Version,
  headers: HeaderMap,
  web_bot_auth: Option<crate::web_bot_auth::WebBotAuthResult>,
  ...
  proxy_protocol: Option<Arc<crate::proxy_protocol::ProxyProtocolMetadata>>,
...
pub(crate) struct StreamWafRequestSeed {
  ...
  pub(crate) web_bot_auth: Option<crate::web_bot_auth::WebBotAuthResult>,
  ...
  pub(crate) proxy_protocol: Option<Arc<crate::proxy_protocol::ProxyProtocolMetadata>>,
...
impl StreamWafRequestContext {
  pub(crate) async fn from_seed(state: &AppSnapshot, seed: StreamWafRequestSeed) -> Option<Self> {
    ...
    let person_proof = match seed.person_proof.clone() {
      ...
      None => state
        ...
        .evaluate_person_proof_request_async(WafRequestInput {
          ...
          client_asn: None,
          web_bot_auth: seed.web_bot_auth.as_ref(),
          ...
          transport_metadata: WafTransportMetadataInput {
            proxy_protocol: seed.proxy_protocol.as_deref(),
    ...
    Some(Self {
      ...
      version: seed.version,
      headers: seed.headers,
      web_bot_auth: seed.web_bot_auth,
      peer_addr: seed.peer_addr,
      downstream_host: seed.downstream_host,
      downstream_scheme: seed.downstream_scheme,
      route_name: seed.route_name,
      ...
      proxy_protocol: seed.proxy_protocol,
      tags: seed.tags,
      dynamic_policy: seed.dynamic_policy,
      person_proof,
  ...
  fn request_input(&self) -> WafRequestInput<'_> {
    WafRequestInput {
      ...
      transport_metadata: WafTransportMetadataInput {
        proxy_protocol: self.proxy_protocol.as_deref(),
