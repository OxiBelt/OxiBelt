...
pub(super) struct ExchangeContext<'state, 'request, 'access, 'transport, 'metadata> {
  ...
  pub(super) no_vary_search: Option<crate::cache::CacheNvsRequest>,
  pub(super) certificate_identity: Option<crate::cache::CacheCertificateIdentity>,
  pub(super) proxy_protocol_identity: Option<crate::cache::CacheProxyProtocolIdentity>,
    ...
    let stream_waf = if resolved.execution_plan.waf.stream_enabled {
      ...
      StreamWafRequestContext::from_seed(
        ...
        StreamWafRequestSeed {
          ...
          web_bot_auth: access_log.web_bot_auth.clone(),
          peer_addr: client_addr,
