...
pub(super) fn allowed_keys(path: &str) -> Option<&'static [&'static str]> {
  let keys: &'static [&'static str] = match path {
    ...
    "tls.ct" => downstream_ct::DOWNSTREAM_CT_CONFIG_KEYS,
    "tls.ct.log_list" => downstream_ct::DOWNSTREAM_CT_LOG_LIST_CONFIG_KEYS,
    "tls.certificates" => &[
      "cert_chain",
      "ct",
      "ocsp",
    ...
    "tls.certificates.ct" => downstream_ct::DOWNSTREAM_CT_CERTIFICATE_CONFIG_KEYS,
    ...
    "proxy.upstream_resolution.happy_eyeballs" => &[
      ...
      "preferred_address_family_count",
      "last_resort_local_synthesis_delay_ms",
      "svcb",
      "pref64",
    ][..],
