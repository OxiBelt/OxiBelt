...
pub(super) struct Stream {
    pub webtransport_outbound: bool,
    pub webtransport_outbound_snapshot: Option<Option<crate::webtransport::SettingsSnapshot>>,
...
impl Stream {
    pub fn new(id: StreamId, init_send_window: WindowSize, init_recv_window: WindowSize) -> Stream {
        ...
        Stream {
            id,
            webtransport_outbound: false,
            webtransport_outbound_snapshot: None,
            state: State::default(),
            ref_count: 0,
            is_counted: false,
