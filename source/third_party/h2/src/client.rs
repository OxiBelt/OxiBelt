  ...
  B: Buf,
{
  ...
  async fn handshake2(
    ...
    let inner = proto::Connection::new(
      ...
      proto::Config {
        ...
        webtransport: crate::webtransport::SettingsHandle::new(),
        data_frame_budget: builder
          .data_frame_budget
          .resolve(builder.initial_target_connection_window_size),
      },
    );
    let webtransport = inner.webtransport_settings();
  ...
  pub fn set_webtransport_settings(
    ...
    self.inner.set_webtransport_settings(settings)?;
    Ok(())
  }
...
impl ResponseFuture {
  /// Returns the peer settings captured when this WebTransport request's
  /// HEADERS were emitted.
  pub fn webtransport_peer_settings(
    &self,
  ) -> Option<Option<crate::webtransport::SettingsSnapshot>> {
    self.inner.webtransport_outbound_snapshot()
  }
