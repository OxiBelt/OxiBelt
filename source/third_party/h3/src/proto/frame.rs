    ...
    fn is_supported(self) -> bool {
        matches!(
            ...
            SettingId::MAX_HEADER_LIST_SIZE
                ...
                | SettingId::WT_INITIAL_MAX_STREAMS_UNI
                | SettingId::WT_INITIAL_MAX_STREAMS_BIDI
                | SettingId::WT_INITIAL_MAX_DATA
...
impl Settings {
    ...
    pub(super) fn decode<T: Buf>(buf: &mut T) -> Result<Settings, SettingsError> {
        ...
        while buf.has_remaining() {
            ...
            if identifier == SettingId::WT_ENABLED && value > 1 {
                return Err(SettingsError::InvalidSettingValue(identifier, value));
            }
