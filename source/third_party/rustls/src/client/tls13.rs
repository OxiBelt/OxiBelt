...
impl ExpectTraffic {
    fn handle_new_ticket_impl(
        ...
        // RFC 9846 section 4.7.1: a client without resumption silently ignores
        // NewSessionTicket, including its contents and ticket processing state.
        if !self.config.resumption.tls13_enabled {
            return Ok(());
        }
