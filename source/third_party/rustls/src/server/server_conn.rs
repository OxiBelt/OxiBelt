...
pub struct ServerConfig {
    ...
    /// Send the TLS 1.3 downgrade sentinel in TLS 1.2 ServerHello.random even
    /// when this particular config only enables TLS 1.2. This is for a server
    /// that also offers TLS 1.3 through a separate config selected per
    /// ClientHello. The default is false.
    pub send_tls13_downgrade_sentinel_on_tls12: bool,
