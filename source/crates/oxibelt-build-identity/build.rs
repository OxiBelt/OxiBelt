#[path = "build/git_identity.rs"]
mod git_identity;
#[path = "src/semver.rs"]
mod semver;

use git_identity::{
  cross_check_git, discover_git_identity, emit_git_rerun_inputs, find_git_marker, workspace_root,
};
use semver::{is_release_version, parse_semver, release_build_revision};
use std::env;
use std::fs;
