...
assert_source_contains "${work_dir}/distributed.yaml" "templates/deployment.yaml" "- /usr/local/bin/oxibelt"
assert_source_contains "${work_dir}/distributed.yaml" "templates/deployment.yaml" "- __lifecycle-prestop"
assert_source_contains "${work_dir}/distributed.yaml" "templates/deployment.yaml" "- --wait-seconds"
assert_source_contains "${work_dir}/distributed.yaml" "templates/deployment.yaml" "- \"10\""
assert_source_not_contains "${work_dir}/distributed.yaml" "templates/deployment.yaml" "/bin/sh"
...
assert_source_contains "${work_dir}/secure_profile.yaml" "templates/deployment.yaml" "- __lifecycle-prestop"
assert_source_contains "${work_dir}/secure_profile.yaml" "templates/deployment.yaml" "- \"300\""
...
assert_source_contains "${work_dir}/secure_daemonset.yaml" "templates/daemonset.yaml" "- __lifecycle-prestop"
assert_source_contains "${work_dir}/secure_daemonset.yaml" "templates/daemonset.yaml" "- \"300\""
