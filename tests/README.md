...
- RISC-V Docker image artifacts use `rust:1.96.0-trixie` as the builder because the official `rust:1.96.0-alpine3.24` image is not published for `riscv64`; the runtime image is still Alpine/musl.
